    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class=" card border-0 " style="box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px; border-radius:3%">
                    ...
                    <div class="card-body border mt-n1 py-4 text-center">
                        <h2 class="h5 mb-1">Butchers</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class="font-weight-semibold">$49.99</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.html">Shop clothing</a>
                    </div>
                </div>
            </div>
            <!-- Category-->
            <div class="col-md-4 col-sm-6" ">
                ...
                <div class="card-body border mt-n1 py-4 text-center">
                    <h2 class="h5 mb-1">Bakery</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class="font-weight-semibold">$49.99</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.html">Shop clothing</a>
                </div>
            </div>
        </div>
        <!-- Category-->
        <div class="col-md-4 col-sm-6" ">
            ...
            <div class="card-body border mt-n1 py-4 text-center">
                <h2 class="h5 mb-1">Vegetables</h2><span class="d-block mb-3 font-size-xs text-muted">Starting from <span class="font-weight-semibold">$49.99</span></span><a class="btn btn-pill btn-outline-primary btn-sm" href="shop-style1-ls.html">Shop clothing</a>
            </div>
        </div>
        <!-- Category-->
