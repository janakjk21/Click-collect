            ...
            <div class=" row">
                ...
                <div class="footcon col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <br>
                        <li>
                            <a href="shop.php"  style="color:white;">MyProducts</a>
                        </li>
                        <li>
                        <br>
                            <a href="traderreg.php"  style="color:white;">Register as Trader</a>
                        </li>
                        <li>
                        <br>
                            <a href="register.php"  style="color:white;">Register as Customer</a>
                        </li>
                    </ul>
                </div>
